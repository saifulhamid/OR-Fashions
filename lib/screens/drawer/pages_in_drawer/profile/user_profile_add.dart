...
import 'package:shak/screens/drawer/pages_in_drawer/profile/user_profile_refactor.dart';

class UserProfileAdd extends StatefulWidget {
  UserProfileAdd({super.key});
                              ...
                              return DropdownButton(
                                  ...
                                  onChanged: (value) {
                                    context
                                        ...
                                        .add(OnSelectGenderEvent(gender: value));
                                  });
                            },
                          ),
                        ],
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    height: 45,
                                    child:
                                        Center(child: Text(dd?.toString() ?? "dd")),
                              ...
                              if (gender != "select a value") {
                                ...
                                showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      content:
                                          Text("Mandatory fields can't be empty!"),
                                      actions: [
                                        TextButton(
                                            onPressed: () {
                                              Navigator.pop(context);
